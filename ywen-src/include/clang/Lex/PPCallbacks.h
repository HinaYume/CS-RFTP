...
public:
  ...
  /// Adding by P
  virtual void PragmaVote(SourceLocation Loc, StringRef Name,
...
public:
  ...
  // Adding by P
  void PragmaVote(SourceLocation Loc, StringRef Name, SourceLocation LocEnd) override {
    First->PragmaVote(Loc, Name, LocEnd);
    Second->PragmaVote(Loc, Name, LocEnd);
  }
