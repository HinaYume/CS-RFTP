...
public:
  ...
  /// Adding by P
  void ActOnPragmaVote(SourceLocation Loc, StringRef Name,
  ...
  /// Adding by P
  void ActOnPendingVotePragma(FunctionDecl *FD);
  void ActOnPragmaVoteProcedure(StringRef funcName);
