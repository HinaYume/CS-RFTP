...
public:
  ...
  /// Adding by P
  virtual void PragmaVote(SourceLocation Loc, StringRef Name, SourceLocation LocEnd, StringRef VoteType) {
  }
...
public:
  ...
  // Adding by P
  void PragmaVote(SourceLocation Loc, StringRef Name, SourceLocation LocEnd, StringRef VoteType) override {
    First->PragmaVote(Loc, Name, LocEnd, VoteType);
    Second->PragmaVote(Loc, Name, LocEnd, VoteType);
  }
